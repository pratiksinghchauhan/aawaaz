...
def revokeMandate(request):
    ...
    <upi:ReqMandate xmlns:upi="http://npci.org/upi/schema/">
        ...
        <Txn id="{txnId}" note="Mandate" custRef="722217098761" refId="XYA5447D86914C14AC1B0A4C4A036B387B3" purpose="00" refUrl="http://axis.com/upi" ts="2018-02-17T13:39:56.040+05:30" initiationMode="00" type="REVOKE" refCategory="00" initiatedBy="PAYER"  OrgTxnId="NPC1249c712571d4984b8909baba68f0fdc">
            <Rules>
                <Rule name="EXPIREAFTER" value="10"/>
            </Rules>
        </Txn>
        <Mandate name="{name}" txnId="{txnId}" ts="{ts}" type="REVOKE" umn="75979u79hyihighi8479579567967967@mypsp" shareToPayee="Y" revokeable="Y" blockFund="Y" OrgTxnId="NPC1249c712571d4984b8909baba68f0fdc">
            <Amount value="{amount}" rule="EXACT"/>
            <Recurrence pattern="{recurrance}">
            </Recurrence>
        </Mandate>
